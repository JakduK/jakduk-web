...
<html lang="ko" ng-app="jakdukApp"> <!--<![endif]-->
	<head>
		...
		<link rel="stylesheet" href="<%=request.getContextPath()%>/bundles/board.edit.css">
	</head>
	...
	<body class="header-fixed">
						...
						<div class="media col-xs-12 col-sm-4" ng-repeat="item in storedImages">
							...
							<div class="media-body">
								<h5 class="media-heading">
									...
									<small><span ng-bind="item.size/1024|number:1"></span> KB</small>
								</h5>
						...
						<div class="media col-xs-12 col-sm-4" ng-repeat="item in uploader.queue">
							...
							<div class="media-body">
								<h5 class="media-heading">
									...
									<small>
										<span ng-bind="item.file.size/1024|number:1"></span> KB
										<code><span ng-bind="item.progress"></span>%</code>
									</small>
								</h5>
		...
		<script src="<%=request.getContextPath()%>/bundles/board.edit.js"></script>
